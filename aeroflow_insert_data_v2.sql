...
-- 7. FLIGHT (15 records)
-- ============================================================
-- Scheduled_Departure/Arrival = first leg's scheduled takeoff and
-- last leg's scheduled landing (kept consistent with Flight_Legs
-- below). Flight_Status: Landed = fully completed, InAir = first
-- leg airborne/later legs pending, Scheduled = not yet departed.
-- Flights 1002 and 1008 carry a deliberate delay to demonstrate
-- Departure_Delay_Minutes / Arrival_Delay_Minutes; all others are
...
VALUES
(1001, 101, '2024-06-01 06:00:00', '2024-06-01 09:50:00', '2024-06-01 06:00:00', '2024-06-01 09:50:00', 'Landed'),
(1002, 102, '2024-06-01 07:30:00', '2024-06-01 09:30:00', '2024-06-01 07:45:00', '2024-06-01 09:50:00', 'Landed'),
(1003, 103, '2024-06-01 09:00:00', '2024-06-01 14:20:00', '2024-06-01 09:00:00', '2024-06-01 14:20:00', 'Landed'),
(1004, 104, '2024-06-01 08:00:00', '2024-06-01 11:50:00', '2024-06-01 08:00:00', '2024-06-01 11:50:00', 'Landed'),
(1005, 105, '2024-06-01 10:00:00', '2024-06-01 11:20:00', '2024-06-01 10:00:00', '2024-06-01 11:20:00', 'Landed'),
(1006, 107, '2024-06-01 06:30:00', '2024-06-01 08:20:00', '2024-06-01 06:30:00', '2024-06-01 08:20:00', 'Landed'),
(1007, 109, '2024-06-01 11:00:00', '2024-06-01 12:15:00', '2024-06-01 11:00:00', '2024-06-01 12:15:00', 'Landed'),
(1008, 110, '2024-06-01 13:00:00', '2024-06-01 17:55:00', '2024-06-01 13:00:00', '2024-06-01 18:15:00', 'Landed'),
(1009, 111, '2024-06-01 07:00:00', '2024-06-01 08:10:00', '2024-06-01 07:00:00', '2024-06-01 08:10:00', 'Landed'),
(1010, 114, '2024-06-02 06:00:00', '2024-06-02 07:45:00', '2024-06-02 06:00:00', '2024-06-02 07:45:00', 'Landed'),
(1011, 115, '2024-06-02 07:00:00', '2024-06-02 08:10:00', '2024-06-02 07:00:00', '2024-06-02 08:10:00', 'Landed'),
(1012, 116, '2024-06-02 08:30:00', '2024-06-02 09:35:00', '2024-06-02 08:30:00', '2024-06-02 09:35:00', 'Landed'),
(1013, 117, '2024-06-02 11:00:00', '2024-06-02 15:00:00', '2024-06-02 11:00:00', NULL,                  'InAir'),
(1014, 120, '2024-06-02 06:00:00', '2024-06-02 07:50:00', '2024-06-02 06:00:00', '2024-06-02 07:50:00', 'Landed'),
(1015, 103, '2024-06-03 10:00:00', '2024-06-03 14:05:00', NULL,                  NULL,                  'Scheduled');


-- ============================================================
-- 8. FLIGHT_LEGS (25 records)
-- ============================================================
-- Leg_Status conformed: Completed -> Landed, In-Flight -> InAir,
-- Scheduled unchanged. Actual_Takeoff/Landing = Scheduled for
-- on-time legs, NULL where not yet occurred, and delayed for the
-- two legs backing Flight 1002 and 1008's demo delays.
...
(1001, 1,  1, '2024-06-01 06:00:00', '2024-06-01 07:15:00', '2024-06-01 06:00:00', '2024-06-01 07:15:00', 'Landed'),
(1001, 5,  2, '2024-06-01 08:00:00', '2024-06-01 09:50:00', '2024-06-01 08:00:00', '2024-06-01 09:50:00', 'Landed'),
-- Flight 1002: BOM->DEL (direct) — 15 min departure delay, 20 min arrival delay
(1002, 8,  1, '2024-06-01 07:30:00', '2024-06-01 09:30:00', '2024-06-01 07:45:00', '2024-06-01 09:50:00', 'Landed'),
-- Flight 1003: AMD->DEL->CCU
(1003, 3,  1, '2024-06-01 09:00:00', '2024-06-01 11:00:00', '2024-06-01 09:00:00', '2024-06-01 11:00:00', 'Landed'),
(1003, 20, 2, '2024-06-01 12:00:00', '2024-06-01 14:20:00', '2024-06-01 12:00:00', '2024-06-01 14:20:00', 'Landed'),
-- Flight 1004: DEL->BLR->MAA
(1004, 10, 1, '2024-06-01 08:00:00', '2024-06-01 09:45:00', '2024-06-01 08:00:00', '2024-06-01 09:45:00', 'Landed'),
(1004, 14, 2, '2024-06-01 10:30:00', '2024-06-01 11:50:00', '2024-06-01 10:30:00', '2024-06-01 11:50:00', 'Landed'),
-- Flight 1005: BLR->MAA (direct)
(1005, 14, 1, '2024-06-01 10:00:00', '2024-06-01 11:20:00', '2024-06-01 10:00:00', '2024-06-01 11:20:00', 'Landed'),
-- Flight 1006: DEL->BLR (direct)
(1006, 10, 1, '2024-06-01 06:30:00', '2024-06-01 08:20:00', '2024-06-01 06:30:00', '2024-06-01 08:20:00', 'Landed'),
-- Flight 1007: AMD->BOM (direct)
(1007, 1,  1, '2024-06-01 11:00:00', '2024-06-01 12:15:00', '2024-06-01 11:00:00', '2024-06-01 12:15:00', 'Landed'),
-- Flight 1008: BOM->HYD->CCU — on-time departure, 20 min late into CCU
(1008, 12, 1, '2024-06-01 13:00:00', '2024-06-01 14:25:00', '2024-06-01 13:00:00', '2024-06-01 14:25:00', 'Landed'),
(1008, 18, 2, '2024-06-01 15:30:00', '2024-06-01 17:55:00', '2024-06-01 15:30:00', '2024-06-01 18:15:00', 'Landed'),
-- Flight 1009: STV->BOM (reuse route 1 reversed, approximate)
(1009, 2,  1, '2024-06-01 07:00:00', '2024-06-01 08:10:00', '2024-06-01 07:00:00', '2024-06-01 08:10:00', 'Landed'),
-- Flight 1010: BLR->DEL (direct)
(1010, 11, 1, '2024-06-02 06:00:00', '2024-06-02 07:45:00', '2024-06-02 06:00:00', '2024-06-02 07:45:00', 'Landed'),
-- Flight 1011: BOM->HYD (direct)
(1011, 12, 1, '2024-06-02 07:00:00', '2024-06-02 08:10:00', '2024-06-02 07:00:00', '2024-06-02 08:10:00', 'Landed'),
-- Flight 1012: JAI->DEL (direct)
(1012, 17, 1, '2024-06-02 08:30:00', '2024-06-02 09:35:00', '2024-06-02 08:30:00', '2024-06-02 09:35:00', 'Landed'),
-- Flight 1013: BOM->HYD->CCU — leg 1 airborne, leg 2 not yet departed
(1013, 12, 1, '2024-06-02 11:00:00', '2024-06-02 12:10:00', '2024-06-02 11:00:00', NULL,                  'InAir'),
(1013, 18, 2, '2024-06-02 13:10:00', '2024-06-02 15:00:00', NULL,                  NULL,                  'Scheduled'),
-- Flight 1014: MAA->CCU (direct)
(1014, 18, 1, '2024-06-02 06:00:00', '2024-06-02 07:50:00', '2024-06-02 06:00:00', '2024-06-02 07:50:00', 'Landed'),
-- Flight 1015: BLR->MAA->CCU — future, not yet departed
(1015, 14, 1, '2024-06-03 10:00:00', '2024-06-03 11:20:00', NULL, NULL, 'Scheduled'),
(1015, 18, 2, '2024-06-03 12:15:00', '2024-06-03 14:05:00', NULL, NULL, 'Scheduled');
...
-- ============================================================
-- Created_At omitted -> defaults to NOW(). Booking_Sequence_No
-- tracks the leg order for multi-leg journeys (see original
-- comment). 'Waitlisted' status required extending the schema's
-- Booking_Status CHECK constraint (see aeroflow_schema_v2.sql).

INSERT INTO Booking
    (Booking_ID, Flight_ID, Route_ID, Leg_Sequence_No, User_ID, Seat_Type,
     Seat_Number, Booking_Date, Booking_Status, Booking_Sequence_No)
VALUES
