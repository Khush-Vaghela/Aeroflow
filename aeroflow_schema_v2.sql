...
-- ------------------------------------------------------------
-- 13. BOOKING
--     Added UNIQUE(leg, Seat_Number) to stop double-assigning a
--     seat on the same leg. Note: this blocks re-selling a seat
--     after a cancellation unless the app deletes/archives
--     cancelled rows first (see README caveat) or this is
--     narrowed to a partial unique index on active statuses.
-- ------------------------------------------------------------
CREATE TABLE Booking (
    ...
    UNIQUE (Flight_ID, Route_ID, Leg_Sequence_No, Seat_Number)
);
