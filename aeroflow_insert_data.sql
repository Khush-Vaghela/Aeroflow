...
-- Booking 510 (Confirmed, seat 30E) — cancel 510 to see the trigger
-- promote 530 into seat 30E automatically (see README "Testing the
-- waitlist trigger").
(530, 1007, 1,  1, 402, 'Economy', NULL,  '2024-05-28', 'Waitlisted', 1);
